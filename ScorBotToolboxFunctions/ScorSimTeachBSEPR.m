function ScorSimTeachBSEPR(varargin)
% SCORSIMTEACHBSEPR teach a specified BSEPR configuration and/or gripper 
% state using specified keys.
%   SCORSIMTEACHBSEPR(scorSim) allows the user to move the ScorBot
%   simulation to a desired BSEPR configuration and/or gripper state using
...
%
%   See also ScorSimInit ScorSimTeachXYZPR
%
