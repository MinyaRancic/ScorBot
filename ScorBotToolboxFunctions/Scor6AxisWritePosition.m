function confirm = Scor6AxisWritePosition(ser, dt, values)
%% SCOR6AXISWRITEPOSITION sends N number of positions to Scor6Axis
...
%   values(1,:) - first set of joint positions
%   values(2,:) - second set of joint positions
%   ...
%   values(N,:) - nth set of joint positions
...
if ~isnumeric(values) || size(values,2) ~= 6
    error('The specified joint values must be Nx6.');
end
